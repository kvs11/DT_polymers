...
def get_params(params_file):
    ...
    pnc_params['main_path'] = '/sandbox/vkolluru/DT_polymers/develop/Jan_2022/workflow_tests/analyze_prev_test_2'
    return pnc_params
#########################
...
calcs_dir = '/sandbox/vkolluru/DT_polymers/develop/Jan_2022/workflow_tests/test_3/calcs'
analysis_dir = '/sandbox/vkolluru/DT_polymers/develop/Jan_2022/workflow_tests/test_3/analysis'
...
axes[1, 2].set_ylim(0.15, 0.35)
axes[1, 2].set_xlim(0, 1000)

plt.subplots_adjust(wspace=0.3, hspace=0.3)
plt.savefig('all_data_lists.png')
plt.close()
###################################################################
