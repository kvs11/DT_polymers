...
def get_perturbed_trajectory(np_box_obj, dia_NPs, copy_astr, min_perturbation, max_perturbation):
...
def get_candidate_soq_residual_V2(cand, pnc_params):
    ...
    for i_traj in range(1, scells_for_one_soq+1):
        copy_astr, num_perturbed = get_perturbed_trajectory(np_box_obj, dia_NPs, copy_astr, min_perturbation, max_perturbation)
